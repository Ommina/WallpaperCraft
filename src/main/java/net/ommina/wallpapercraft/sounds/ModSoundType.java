...
public class ModSoundType extends SoundType {
    ...
    public static ModSoundType STONE = new ModSoundType( 1.0F, 1.0F, SoundEvents.BLOCK_STONE_BREAK, SoundEvents.BLOCK_STONE_STEP, SoundEvents.BLOCK_STONE_PLACE, ModSoundEvents.BLOCK_CHANGE_IN_WORLD, SoundEvents.BLOCK_STONE_FALL );

    RegistryObject<SoundEvent> hitSound;
